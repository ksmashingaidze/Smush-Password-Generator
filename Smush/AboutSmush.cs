...
{   //Property of Kuziwakwashe Stephen Mashingaidze
    [Activity(Label = "@string/content_sixth_name", ScreenOrientation = Android.Content.PM.ScreenOrientation.Portrait)]
    public class AboutSmush : AppCompatActivity
    {
        ...
        protected override void OnCreate(Bundle savedInstanceState)
        {
            ...
            SetContentView(Resource.Layout.content_sixth);
            ...
            //Locate Background
            RelativeLayout bg = FindViewById<RelativeLayout>(Resource.Id.aboutlayout);
        ...
        {
            MenuInflater.Inflate(Resource.Menu.menu_sixth, menu);
            return true;
        }
